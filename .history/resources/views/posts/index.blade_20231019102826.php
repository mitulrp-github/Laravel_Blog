...
<div class="row my-4">
	...
	<dotlottie-player src="https://lottie.host/272b60dd-462d-42a3-8ed6-fec4143633d6/X4FxBascRI.json" background="transparent" speed="1" style="width: 300px; height: 300px" direction="1" mode="normal" loop controls autoplay></dotlottie-player>
</div>
...
<div class="row">
	...
	<div class="col-lg-8 my-4">
		<div class="float-start">
			<h4>Laravel CRUD Application</h4>
		</div>
		<div class="float-end">
